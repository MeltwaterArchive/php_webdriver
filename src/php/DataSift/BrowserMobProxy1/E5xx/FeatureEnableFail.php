...
/**
 * Exception thrown when we've failed to enable a feature in our copy
 * of browsermob-proxy
 *
 * @category Libraries
 * @package  BrowserMobProxy1
...
class E5xx_FeatureEnableFail extends Exxx_Exception
{
	public function __construct($name) {
		$msg = "Failed to enable browsermob-proxy feature: '{$name}'";
