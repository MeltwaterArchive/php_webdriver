...
/**
 * Exception thrown when we've failed to disable a feature in our copy
 * of browsermob-proxy
 *
 * @category Libraries
 * @package  BrowserMobProxy1
...
class E5xx_FeatureDisableFail extends Exxx_Exception
{
	public function __construct($name) {
		$msg = "Failed to disable browsermob-proxy feature: '{$name}'";
