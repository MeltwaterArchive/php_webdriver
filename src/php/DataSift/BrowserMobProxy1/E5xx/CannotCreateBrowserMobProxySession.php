...
/**
 * Exception thrown when we run into problems creating a new
...
class E5xx_CannotCreateBrowserMobProxySession extends Exxx_Exception
{
	public function __construct() {
		$msg = "Unable to create browsermob-proxy session";
