...
/**
 * Exception thrown when an attempt to enable a named input engine fails
 * unexpectedly
 *
 * @category Libraries
 * @package  WebDriver1
...
class E5xx_IMEEngineActivationFailedWebDriverError extends E5xx_WebDriverException
{
