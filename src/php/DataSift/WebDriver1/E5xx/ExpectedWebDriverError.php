...
/**
 * Exception thrown when an error occurred inside WebDriver that was
 * supposed to happen.  Seriously.
 *
 * @category Libraries
 * @package  WebDriver1
 * @license  http://www.apache.org/licenses/LICENSE-2.0
...
class E5xx_ExpectedWebDriverError extends E5xx_WebDriverException
{
