...
/**
 * Exception thrown when we run a piece of JavaScript that doesn't
 * return a result (I think)
 *
 * @category Libraries
 * @package  WebDriver1
 * @license  http://www.apache.org/licenses/LICENSE-2.0
...
class E5xx_NoScriptResultWebDriverError extends E5xx_WebDriverException
{
