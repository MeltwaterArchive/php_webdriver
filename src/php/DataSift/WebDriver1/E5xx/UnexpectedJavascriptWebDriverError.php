...
/**
 * Exception thrown when JavaScript we've loaded into the browser via
 * WebDriver has gone wrong
 *
 * @category Libraries
 * @package  WebDriver1
 * @license  http://www.apache.org/licenses/LICENSE-2.0
...
class E5xx_UnexpectedJavascriptWebDriverError extends E5xx_WebDriverException
{
