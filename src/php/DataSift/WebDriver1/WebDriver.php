...
class WebDriver extends WebDriverBase
{
     ...
     *
     * @param  string           $browser                 the name of the browser to use
     * @param  array            $additional_capabilities a list of the capabilities that are needed for this test
     *
     * @return WebDriverSession the new WebDriverSession to use to control the browser
     */
     ...
     *
     * @return array(WebDriverSession) a list of the sessions that webdriver currently knows about
     */
