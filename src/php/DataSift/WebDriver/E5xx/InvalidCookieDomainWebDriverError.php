...
/**
 * Exception thrown when we attempt to create a cookie, but use an
 * invalid (malformed) domain.
 *
 * @category Libraries
 * @package  WebDriver
 * @license  http://www.apache.org/licenses/LICENSE-2.0
...
class E5xx_InvalidCookieDomainWebDriverError extends E5xx_WebDriverException
{
